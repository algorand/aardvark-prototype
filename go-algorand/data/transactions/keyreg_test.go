...
func (balances keyregTestBalances) Get(addr basics.Address, pf basics.AccountProof) (basics.BalanceRecord, error) {
	return balances.addrs[addr], nil
}

func (balances keyregTestBalances) Put(basics.BalanceRecord, basics.AccountProof) error {
	return nil
}

func (balances keyregTestBalances) Move(basics.Address, basics.Address, basics.AccountProof, basics.AccountProof, basics.MicroAlgos, *basics.MicroAlgos, *basics.MicroAlgos) error {
	return nil
}

func (balances keyregTestBalances) Clear(basics.Address, basics.AccountProof, basics.AccountProof) error {
	return nil
}
...
func TestKeyregApply(t *testing.T) {
	...
	_, err := tx.Apply(mockBalances{protocol.ConsensusCurrentVersion}, TransactionProof{}, SpecialAddresses{FeeSink: feeSink})
	...
	_, err = tx.Apply(mockBal, TransactionProof{}, SpecialAddresses{FeeSink: feeSink})
	require.NoError(t, err)
