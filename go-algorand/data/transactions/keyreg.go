...
func (keyreg KeyregTxnFields) apply(header Header, pf TransactionProof, balances Balances, spec SpecialAddresses) error {
	...
	// record, err := balances.Get(header.Sender, pf.Sender)
	// if err != nil {
	// 	return err
	// }
