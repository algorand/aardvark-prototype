...
func (balances mockBalances) Get(basics.Address, basics.AccountProof) (basics.BalanceRecord, error) {
	return basics.BalanceRecord{}, nil
}

func (balances mockBalances) Put(basics.BalanceRecord, basics.AccountProof) error {
	return nil
}

func (balances mockBalances) Clear(basics.Address, basics.AccountProof, basics.AccountProof) error {
	return nil
}

func (balances mockBalances) Move(basics.Address, basics.Address, basics.AccountProof, basics.AccountProof, basics.MicroAlgos, *basics.MicroAlgos, *basics.MicroAlgos) error {
	return nil
}
...
func TestPaymentApply(t *testing.T) {
	...
	_, err := tx.Apply(mockBalV0, TransactionProof{}, SpecialAddresses{FeeSink: feeSink})
