...
func initConsensusProtocols() {
	...
	vFastSVT := v17
	vFastSVT.SeedRefreshInterval = 3
	vFastSVT.MaxTxnLife = 30
	vFastSVT.AccountVectorSize = 10
	Consensus[protocol.ConsensusFastSVT] = vFastSVT
}
